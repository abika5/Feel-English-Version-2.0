...
@app.route('/level1_basic_animals')
def level1_basic_animals():
	username = session.get("username")
	return render_template('level1_basic_animals.html')

@app.route('/level3_basic')
def level3_basic():
	username = session.get("username")
	return render_template('level3_basic.html')

@app.route('/level1_basic_main')
def level1_basic_main():
	username = session.get("username")
	return render_template('level1_basic_main.html')

@app.route('/level2_basic_main')
def level2_basic_main():
	username = session.get("username")
	return render_template('level2_basic_main.html')

@app.route('/level1_basic_food')
def level1_basic_food():
	username = session.get("username")
	return render_template('level1_basic_food.html')

@app.route('/level1_basic_bodyparts')
def level1_basic_bodyparts():
	username = session.get("username")
	return render_template('level1_basic_bodyparts.html')

@app.route('/level2_basic_animals')
def level2_basic_animals():
	username = session.get("username")
	return render_template('level2_basic_animals.html')

@app.route('/level2_basic_bodyparts')
def level2_basic_bodyparts():
	username = session.get("username")
	return render_template('level2_basic_bodyparts.html')
...
@app.route('/intermediate/statements',methods=['GET','POST'])
def statements():
	username = session.get("username")
	return render_template('statements.html')

@app.route('/intermediate/conversations',methods=['GET','POST'])
def conversations():
	username = session.get("username")
	return render_template('conversations.html')

@app.route('/intermediate/grammar',methods=['GET','POST'])
def grammar():
	username = session.get("username")
	return render_template('grammar.html')

@app.route('/intermediate/questions',methods=['GET','POST'])
def questions():
	username = session.get("username")
...
@app.route('/advanced/writing',methods=['GET','POST'])
def writing():
	username = session.get("username")
	return render_template('writing.html')

@app.route('/advanced/games',methods=['GET','POST'])
def games():
	username = session.get("username")
